...
<!-- Knopf 4 Karte-->
    <li class="dropdown">
      <a class="menulink"  href="/Map" title="Auf der Karte sind die aktiven Netzknoten dargestellt.">Netzkarte</a>
      <ul class="dropdown-menulink">
        <li>
          <a href="/netz-status/nodelist.php" title="Knotenliste.">Netzknotenliste</a>
        </li>
        <li>
          <a href="/topologie.php" title="Verbindung der Netzknoten zueinander.">Topologie</a>
        </li>
	<li>
	   <a href="/netz-status/index.php" title="Status des Internetzugangs und OLSR">OLSR Nachbarn</a>
        </li>
	<li>
          <a href="/netz-status/viz-index.php" title="Visualisierung des Freifunk-Mesh-Netzes.">OLSR-VIZ</a>
        </li>
	<li>
    ...
    <li>
      <a href="/verein" title="F&ouml;rderverein Freie Netzwerke Halle">F&ouml;rderverein</a>
    </li>

<!-- Knopf 5 Links -->
    <li class="dropdown">
      <a class="menulink" href="/wir-links-mitmachen/links.php" title="Linkempfehlungen">Links</a>
      <ul class="dropdown-menulink">
	<li>
...
<!-- Knopf 6 Impressum -->
    <li>
      <a href="/impressum.php" title="Angaben gem&auml;&szlig; &sect; 5 Telemediengesetz">Impressum</a>
    </li>
