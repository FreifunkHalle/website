...
<head>
  ...
  <title>Freifunk Halle :: Mitmachen</title>
...
<?php require_once("mitmachen-sidebar.php"); ?>
	...
	<li>
	der Verbreitung der Idee auf Veranstaltungen, und
	</li>
...
<!-- ende level -->
	<h2>Weitere Informationen und Hinweise</h2>

	<p>
	Wo stehen schon Freifunk-Router? Schau mal auf der Netzkarte nach. 
...
<h2>Störerhaftung und VPN-Tunnel</h2>
	...
	<ul>
		<?php require_once("../treffen-termin-fuer-mitmachen.php"); ?>
	</ul>
